...
python tools/deploy_local.py --project-addons 'D:\Blender\Projects\Character\X\addons'
python tools/deploy_local.py --project-addons 'D:\Blender\Projects\Character\X\addons' --check
```
