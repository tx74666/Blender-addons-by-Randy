...
def load_package(filepath):
    ...
    return validate_package(data, str(path))


def validate_package(data, label='Embedded Unity animation'):
    """Validate file or persistently embedded collection input by the same rules."""
